...
const LabelGenerator = () => {
    ...
    //             shipmentData.shipment_type === "Indian Post" ? 50 : ((shipmentData.payment_type === "F2F" || shipmentData.shipment_type === "F2F") ? 35 : 50),
    //             "top",
    //             (shipmentData.shipment_type === "F2F" || shipmentData.payment_type === "F2F") ? 170 : 200
    //         );



    //         const barcodeRef = createBarcode(shipmentData.ref, 35, "bottom", 170);
    ...
    //         const textMargin = 2; // Margin between text and barcode
    ...
    //         // Draw COD box content centered
    //         const box1X = marginLeft + barcodeWidth + 5 + boxWidth / 2;
    //         let currentY = startY;

    //         doc.text(box1Line1, box1X, currentY, { align: "center" });
    //         currentY += box1Line1Height + gap;

    //         doc.setFont("Times", "Roman");
    //         doc.text(box1Line2, box1X, currentY, { align: "center" });
    //         currentY += box1Line2Height + gap;

    //         doc.text(box1Line3, box1X, currentY, { align: "center" });

    //         yOffset += boxHeight + 4;

    //         // Second row - Reference Barcode (text at bottom)
    //         const secondBoxWidth = 45;
    ...
    //         doc.text(box2Line1, box2X, currentYBox2, { align: "center" });
    //         currentYBox2 += box2Line1Height + gap;

    //         doc.text(box2Line2, box2X, currentYBox2, { align: "center" });
    //         currentYBox2 += box2Line2Height + gap;

    //         doc.text(box2Line3, box2X, currentYBox2, { align: "center" });

    //         // Add reference barcode first (above text)
    ...
    //         // [Rest of the shipping details code remains the same...]
    //     });
    ...
    //         // Add reference barcode above text
    //         const barcodeRef = createBarcode(shipmentData.ref, remainingHeight);
    //         doc.addImage(
    //             barcodeRef,
    //             "PNG",
