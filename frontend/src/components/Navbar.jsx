...
//     return (
//         <nav className="bg-white shadow-md border-b border-gray-200 h-16 fixed w-full z-10 flex items-center">
//             <button
//                 onClick={toggleSidebar}
//                 className="p-2 ml-2 rounded-md text-gray-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200"
//             >
//                 <Menu size={24} />
//             </button>
