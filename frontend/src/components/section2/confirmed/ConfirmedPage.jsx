...
//     //                         break
//     //                     }
//     //                     for (const product of value.value) {
//     //                         if (Object.keys(product).length === 0 || Object.values(product)[0] === "") {
//     //                             isValid = false
//     //                             break
//     //                         }
//     //                     }
//     //                 } else if (!value.value || value.value.toString().trim() === "") {
//     //                     isValid = false
//     //                     break
//     //                 }
//     //             }
...
//         switch (type) {
//             case "all":
//                 csvContent = convertToCSV(filteredData)
//                 filename = "all_confirmed_data.csv"
//                 break
//             case "indian_post":
//                 csvContent = convertToCSV(filteredData.filter((item) => item.shipment_type?.value === "Indian Post"))
