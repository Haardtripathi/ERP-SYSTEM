...
//             const response = await getAllLead(queryParams.toString())
...
//         fetchData(1, Number(value), searchTerm, searchColumn, filterStatus)
//     }
...
// const LeadPage = () => {
//     console.log("LeadPage component mounting")
//     const [leadData, setLeadData] = useState([])
//     const [currentPage, setCurrentPage] = useState(1)
//     const [itemsPerPage, setItemsPerPage] = useState(10)
//     const [totalPages, setTotalPages] = useState(1)
...
//         // More lenient permissions check
//         if (!permissions) {
//             console.error("No permissions object found")
//             // Don't redirect immediately, try to continue
//             setColumnPermissions([])
//             return
//         }

//         // Check if user has access to this page, but with more debugging
//         if (!permissions.page) {
//             console.error("No page permission found in:", permissions)
//             // Continue anyway for debugging
//         } else if (permissions.page !== "/leads") {
//             console.error(`Page permission mismatch: expected "/leads", got "${permissions.page}"`)
//             // Continue anyway for debugging
//         }
...
//     const hasColumnPermission = (columnName) => {
//         // Temporary: return true for all column permissions to debug the page
//         return true
...
//             // Add filter status if not "All"
//             if (status === "isSent") {
//                 queryParams.append("isSent", "true")
//             } else if (status === "isNotSent") {
//                 queryParams.append("isSent", "false")
//             }
//             // For "All", we don't add any filter parameter
