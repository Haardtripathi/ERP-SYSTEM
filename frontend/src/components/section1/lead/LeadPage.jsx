...
//         // Only reset currentPage when search term changes
//         if (searchTerm !== "") {
//             setCurrentPage(1)
//         }
...
//                         All
//                     </Button>
//                     <Button onClick={() => setFilterStatus("isSent")} variant={filterStatus === "isSent" ? "default" : "outline"}>
//                         Is Sent
//                     </Button>
//                     <Button
...
//                         <DialogDescription>Please review the lead data before sending to pending.</DialogDescription>
//                     </DialogHeader>
//                     {selectedItem && (
//                         <div className="mt-4">
//                             <p>
...
//             setCurrentPage(1)
//         }
//     }, [searchTerm, leadData, itemsPerPage, filterStatus, currentPage])
...
const LeadPage = () => {
    ...
    //             toast.error(`${key.replace(/_/g, " ")} is required`)
    //             isValid = false
    //         } else if (typeof value === "string" && (value.trim() === "" || value === null || value === "")) {
    //             //console.log("2")
    //             toast.error(`${key.replace(/_/g, " ")} is required`)
    //             isValid = false
    //         }
    //         else if (typeof value === "object" && (value.value === null || value.value === "" || value === null)) {
    //             //console.log("3")
    //             toast.error(`${key.replace(/_/g, " ")} is required`)
    //             isValid = false
    //         }
    ...
    //     if (formData.alternate_phone && formData.alternate_phone !== "" && !phoneRegex.test(String(formData.alternate_phone))) {
    //         toast.error("Alternate phone number must be 10 digits");
    //         return false;
    //     }
