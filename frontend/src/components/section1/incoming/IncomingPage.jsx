...
//             toast.error("You don't have permission to delete incomings")
//             return
//         }
...
//             toast.error("You don't have permission to update incomings")
//             return
//         }
...
//             toast.error("You don't have permission to send incomings to pending")
//             return
//         }
...
const IncomingPage = () => {
    ...
    const handleDelete = async (id) => {
        if (!permissions.canDelete) {
            toast.error("You don't have permission to delete incoming")
            return
        }
    ...
    const handleUpdateClick = async (id, is_sent_to_pending) => {
        if (!hasColumnPermission("update")) {
            toast.error("You don't have permission to update incoming")
            return
        }
    ...
    const handleSendToPending = async (id) => {
        if (!hasColumnPermission("is_sent_to_pending")) {
            toast.error("You don't have permission to send incoming to pending")
            return
        }
