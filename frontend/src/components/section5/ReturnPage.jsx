...
// import { getAllReturn } from "@/services/returnService"
...
//             console.error("Return data is not an array")
//             return
//         }
...
//                                     <TableCell>
//                                         {Array.isArray(item.dispatchedId.confirmedId?.products?.value) && item.dispatchedId.confirmedId.products.value.length > 0
