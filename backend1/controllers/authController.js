...
// const Dropdown = require("../models/Dropdown") // Removed Dropdown import
...
// Removed exports.getAgentList function
...
exports.register = [
    ...
    async (req, res) => {
        ...
        try {
            ...
            // Changed hardcoded admin check to role-based check
            if (decoded.role !== "admin") { // Assuming 'role' is available in the decoded token
